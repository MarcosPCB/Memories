<?php
    ...
    if(isset($_GET['e']))
    {
        echo('<script> console.log("ERROR_CODE:'.$_GET['e'].'"); </script>');
        
        if(isset($_GET['o']))
        {
            $str = hex2bin($_GET['o']);
            
            echo('<script> console.log("ERROR_OUTPUT:'.$str.'"); </script>');
        }
    }
    ...
    <div class="container-fluid">
        <div class="row justify-content-center align-items-center vh-100">
            <div class="col-8 text-center">
                <h4 class="font-mont-light text-white">Poxa, alguma coisa deu errado no processo. Vamos tentar novamente?</h4>
